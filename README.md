...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/unasync-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12161&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/unasync-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `unasync` can be installed with:

```
conda install unasync
```

It is possible to list all of the versions of `unasync` available on your platform with:
